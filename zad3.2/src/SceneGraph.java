...
public class SceneGraph extends JPanel {
    ...
    private TransformedObject rect1,rect2,rect3;
    private TransformedObject Figure0, Figure1_1,Figure1_2,Figure2_1,Figure2_2,Figure3_1,Figure3_2;
    /**
    ...
    private void createWorld() {
        ...
        Figure0 = new TransformedObject(Figure);

        Figure1_1 = new TransformedObject(Figure);
        Figure1_2 = new TransformedObject(Figure);
        ...
        Figure2_1 = new TransformedObject(Figure);
        Figure2_2 = new TransformedObject(Figure);

        triangle3 = new TransformedObject(filledTriangle);
        rect3 = new TransformedObject(filledRect);
        Figure3_1 = new TransformedObject(Figure);
        Figure3_2 = new TransformedObject(Figure);
        ...
        rect1
                ...
                .setRotation(-15)
                .setColor(Color.RED);
        triangle1.setTranslation(-2.5,0.7)
                .setScale(0.7,1.5)
        ...
        Figure2_2
                ...
                .setScale(0.004,0.004)
                .setColor(Color.BLACK);
        rect2.setTranslation(0,-0.2)
                .setScale(2.2,0.3)
                .setRotation(-15)
                .setColor(Color.RED);
        triangle2.setTranslation(0,-2.2)
                .setScale(1,2)
        ...
        Figure3_2
                ...
                .setScale(0.002,0.002)
                .setColor(Color.BLACK);
        rect3.setTranslation(2.5,2.4)
                .setScale(1.8,0.2)
                .setRotation(-15)
                .setColor(Color.RED);
        triangle3.setTranslation(2.5,1.1)
                .setScale(0.6,1.3)
    ...
    public void updateFrame() {
        ...
        Figure0.setRotation(frameNumber*0.75);
        Figure1_1.setRotation(frameNumber*0.75);
        Figure1_2.setRotation(frameNumber*0.75);
        Figure2_1.setRotation(frameNumber*0.75);
        Figure2_2.setRotation(frameNumber*0.75);
        Figure3_1.setRotation(frameNumber*0.75);
        Figure3_2.setRotation(frameNumber*0.75);
    ...
    private static SceneGraphNode Figure = new SceneGraphNode() {
        void doDraw(Graphics2D g) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                g.draw( new Line2D.Double( 0,0, (int) (150 * Math.cos(i * 2 * Math.PI / n)),(int) (150 * Math.sin(i * 2 * Math.PI / n))) );
            }
