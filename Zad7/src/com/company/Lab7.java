...
public class Lab7 extends JPanel implements GLEventListener {
	...
	// TODO: piramida1
	private void pyramid2(GL2 gl)
	{
		gl.glVertex3f(-1.f, -1.f, 0.f);
		gl.glTexCoord2d(0.f, 0.f);
		gl.glVertex3f(1.f, -1.f, 0.f);
		gl.glTexCoord2d(0.f, 1.f);
		gl.glVertex3f(0.f, 3.f, 2.412f);
		gl.glTexCoord2d(1.f, 0.f);
	}
	...
	private void pyramid(GL2 gl){
		...
		for (int i = 1; i < 11; ++i)
		{
			gl.glPushMatrix();
			{
				gl.glTranslatef(0.0f, 0.0f, 2.412f);
				gl.glRotatef(i * 45, 0.0f, 1.0f, 0.f);
				gl.glTranslatef(0.0f, 0.0f, -2.412f);
	...
	//TODO: dodanie tekstury z rysowania
	...
	public void display(GLAutoDrawable drawable) {
		...
		// TODO: Spawdzanir poprawności tekstur

		Texture texture = currentTexture;
		// sprawdzanie że jeżeli nie ma obiektu to nie ustawiam, a jeżeli jest to wczytuję teksturę
		// zabezpieczenie żeby nie nakładać na pustą teksturę
